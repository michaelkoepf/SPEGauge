...
public class Bid implements Serializable {
  ...
  public Bid(
      long auction,
      long bidder,
      long price, /*String channel, String url,*/
      Instant dateTime,
      String extra) {
  ...
  public Bid(String[] attrs) {
    this.auction = Long.parseLong(attrs[1]);
    this.bidder = Long.parseLong(attrs[2]);
    this.price = Long.parseLong(attrs[3]);
    this.dateTime = Instant.parse(attrs[4]);
    this.extra = attrs[5];
  }
