...
public class ThreeWayJoinWindowQ1 extends QueryGroup<Tuple2<EntityRecordFull, EntityRecordFull>> {
    ...
    public List<DataStream> register(StreamExecutionEnvironment env) throws Exception {
        ...
        var result1 = joinResult.keyBy(e -> e.f0.longAttribute1).process(new MaxKeyedProcessFunction()).setParallelism(getParallelism());
