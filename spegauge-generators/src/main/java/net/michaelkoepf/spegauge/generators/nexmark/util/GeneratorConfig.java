...
import net.michaelkoepf.spegauge.generators.nexmark.NEXMarkEvent;
import net.michaelkoepf.spegauge.generators.nexmark.NEXMarkEventGenerator;
...
/** Parameters controlling how {@link NEXMarkEventGenerator} synthesizes {@link NEXMarkEvent} elements. */
public class GeneratorConfig implements Serializable {
  ...
  public GeneratorConfig(
    ...
    if (maxEvents <= 0) {
      throw new IllegalStateException("Overflow of proportions... decrease their sum");
    }
    ...
    if (maxEventsOrZero == 0) {
      ...
      if (maxEventsOrZero > maxEvents) {
        throw new IllegalStateException("Desired number of events (" + maxEventsOrZero + ") exceeds the maximum number of events (" + maxEvents + "). Reduce number of events to be producer or proportions.");
      }
