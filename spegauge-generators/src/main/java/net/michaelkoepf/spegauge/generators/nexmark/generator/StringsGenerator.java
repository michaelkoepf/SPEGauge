...
public class StringsGenerator {
  ...
  public static String nextString(UniformRandomProvider random, int maxLength) {
    return nextString(random, maxLength, ' ');
  }

  public static String nextString(UniformRandomProvider random, int maxLength, char special) {
  ...
  public static String nextExactString(UniformRandomProvider random, int length) {
    StringBuilder sb = new StringBuilder();
    int rnd = 0;
   ...
   * {@code averageSize}.
   */
  public static String nextExtra(UniformRandomProvider random, int currentSize, int desiredAverageSize) {
